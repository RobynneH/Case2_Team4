...
st.write("For this dashboard we've performed Exploratory Data Analysis on this dataset and made several data visualizations, attempting to describe and show which variables had most influence on passenger satisfaction.")
st.divider()
